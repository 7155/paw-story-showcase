...
const actions: GoldenAction[] = ['create', 'draft', 'review_case', 'label_sample', 'judge_config', 'calibrate', 'freeze', 'experiment', 'supplement_source', 'cancel', 'resume', 'reprocess_calibration', 'rejudge_uncertain_calibration'];
