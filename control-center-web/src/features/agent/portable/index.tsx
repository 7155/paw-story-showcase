...
import type { PortableBridge, PortableConversationOptions } from './conversation-types';
...
declare global { interface Window { pawAgentUI: typeof portableAgentUI; pawApp: PortableBridge } }
...
const portableAgentUI = {
  ...
  mountConversation(element: HTMLElement, options: PortableConversationOptions) {
    const root = createRoot(element);
    root.render(<TooltipProvider><PortableConversation options={options} bridge={window.pawApp} /></TooltipProvider>);
